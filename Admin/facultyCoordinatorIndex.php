...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="facultyCoordinatorIndex.php">Administrator</a><button class="btn btn-link btn-sm order-1 order-lg-0"
            ...
            <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="facultyCoordinatorIndex.php">
                        ...
                        <a class="nav-link" href="facultyCoordinatorData.php">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4 text-center">Dashboard for Faculty Coordinator <?php echo $_SESSION["adminDepartment"];?> </h1>
