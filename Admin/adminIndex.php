...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="adminIndex.php">Administrator</a><button class="btn btn-link btn-sm order-1 order-lg-0"
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="charts.html">
                            ...
                            Charts
                        </a><a class="nav-link" href="adminIndexData.php">
...
?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password" id="password"
                                ...
                                <div class="form-group">
                                    <input class="btn btn-primary btn-block mb-5" type="submit" class="form-control"
                                        name="login" id="login" value="ADD PROFILE">
                                </div>
                            </form>
                        </div>
                        <div class="col"></div>
