...
<div class="text-center mb-3 nav-link">
 <a href="facultyCoordinatorIndex.php" class="text-center text-white btn btn-warning">Go to Dashboard</a>
 </div>
...
$sql ="select * FROM user_information INNER JOIN event_information ON user_information.email= event_information.email WHERE event_information.event IN (SELECT admin_information.adminEvent 
