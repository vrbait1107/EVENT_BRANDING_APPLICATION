	...
	<form method="post" action="">
		...
		<table style="border: 1px solid nopadding" class="table table-bordered">
			<tbody>
				...
				?>
				<tr >
					<td style="border: 1px solid" class="text-info font-weight-bold"><label><?php echo $paramName?></label></td>
					<td style="border: 1px solid" class="text-info font-weight-bold"><?php echo $paramValue?></td>
				</tr>
				<?php
					}
				?>
