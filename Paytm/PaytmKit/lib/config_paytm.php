...
define('PAYTM_MERCHANT_MID', $merchantMid); //Change this constant's value with MID (Merchant ID) received from Paytm.
define('PAYTM_MERCHANT_WEBSITE', $merchantWeb); //Change this constant's value with Website name received from Paytm.
