...
<body>
    ...
    <section class="mb-4">
        ...
        <!--Section heading-->
        <h2 class="h1-responsive font-weight-bold text-center my-4 text-uppercase text-primary animated zoomIn slow">
            Contact us</h2>
        <!--Section description-->
        <h5 class="text-center w-responsive mx-auto mb-5 animated zoomIn slow">Do you have any questions? Please do not
