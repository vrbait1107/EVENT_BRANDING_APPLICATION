...
$sql = "SELECT * FROM events_details_information WHERE eventDepartment ='Electronics & Telecommunication'";
...
echo '<h1 class="text-danger text-uppercase font-weight-bold text-center mb-5 title">WELCOME TO EXTC EVENTS</h1>';
echo '<div class="row">';
